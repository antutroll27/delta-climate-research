...
export interface Member {
  ...
  first: string;
  last: string;
  tier: string; // job title, e.g. 'Head of Operations'; founder standing prefixed where it applies
  // Domain area. MUST NOT restate `tier` — the profile panel renders `{tier} · {discipline}`,
  // so 'Head of Communications' + 'Communications' reads as a stutter. Pick from `focus`.
  discipline: string;
...
export const team: Member[] = [
  {
    id: '01', first: 'Angad', last: 'Burman', tier: 'Founder · Head of Climate Analytics', discipline: 'Geospatial Intelligence', mono: 'AB', cover: 1,
  ...
  {
    id: '02', first: 'Shirsha', last: 'Sen', tier: 'Co-Founder · Head of Climate Policy & Regulation', discipline: 'Regulatory Frameworks', mono: 'SS', cover: 2,
  ...
  {
    id: '03', first: 'Dhruv', last: 'Maniktala', tier: 'Head of Operations', discipline: 'Operations Research', mono: 'DM', cover: 3,
  ...
  {
    id: '04', first: 'Antariksha', last: 'Kumar', tier: 'Head of Technology Innovation', discipline: 'Platform Engineering', mono: 'AK', cover: 4,
    ...
    bio: [
      ...
      "As Head of Technology Innovation, Antariksha eliminates friction between backend data models and end-user execution. Experienced in deploying SaaS applications, running real-time data pipelines, and engineering agentic workflows with Claude Code, he drives the team's analytics-visualisation goals — translating intricate cross-platform data models into high-performance, intuitive dashboards that scale real-world impact.",
    ],
  ...
  {
    id: '05', first: 'Roshni', last: 'Rakshit', tier: 'Head of Communications', discipline: 'Science Storytelling', mono: 'RR', cover: 2,
