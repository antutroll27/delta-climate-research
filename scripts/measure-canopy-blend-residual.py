...
#: as a module constant baked at Kolkata's 1400 m. This measurement is
#: Kolkata-only, and `uniform_grid` refuses the moment the ward table holds two
#: footprints — which is exactly when one number for "the" grid stops being a fact.
